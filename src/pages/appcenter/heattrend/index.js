      ...
      <div className="normal">
        ...
        <div className="tablebg">
          <div style={{ marginTop: 12, marginBottom: 12 }}>
            ...
            <CheckableTag checked={checked1} onChange={this.handleChange1}>
              综合
            </CheckableTag>
            <CheckableTag checked={checked2} onChange={this.handleChange2}>
              个股
            </CheckableTag>
            <CheckableTag checked={checked3} onChange={this.handleChange3}>
              行业
            </CheckableTag>
            <CheckableTag checked={checked4} onChange={this.handleChange4}>
              概念
            </CheckableTag>
          </div>
          ...
          <Row gutter={24}>
            {(checked1 || checked2) && (
              <Col span={12} style={{ marginBottom: 24 }}>
                <Card title="个股综合热度趋势图" bordered={false}>
                  <HeatTrendChart />
                </Card>
              </Col>
            )}
            {(checked1 || checked3) && (
              <Col span={12} style={{ marginBottom: 24 }}>
                <Card title="行业综合热度趋势图" bordered={false}>
                  <HeatTrendChart />
                </Card>
              </Col>
            )}
            {(checked1 || checked4) && (
              <Col span={12} style={{ marginBottom: 24 }}>
                <Card title="概念综合热度趋势图" bordered={false}>
                  <HeatTrendChart />
                </Card>
              </Col>
            )}
            {checked2 && (
              <Col span={12} style={{ marginBottom: 24 }}>
                <Card title="个股舆论热度趋势图" bordered={false}>
                  <HeatTrendChart />
                </Card>
              </Col>
            )}
            {checked3 && (
              <Col span={12} style={{ marginBottom: 24 }}>
                <Card title="行业舆论热度趋势图" bordered={false}>
                  <HeatTrendChart />
                </Card>
              </Col>
            )}
            {checked4 && (
              <Col span={12} style={{ marginBottom: 24 }}>
                <Card title="概念舆论热度趋势图" bordered={false}>
                  <HeatTrendChart />
                </Card>
              </Col>
            )}
